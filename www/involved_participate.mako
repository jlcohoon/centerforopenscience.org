...
<div class="col-md-3 col-sm-3 community-tab-list">
    <ul class="tabbable community-tabbable">
        <li class="active"><a href="#tab_1" data-toggle="tab">Scientists</a></li>
        <li><a href="#tab_2" data-toggle="tab">Journals and Societies</a></li>
        <li><a href="#tab_3" data-toggle="tab">Developers</a></li>
        <li><a href="#tab_4" data-toggle="tab">Ambassadors</a></li>
    </ul>
</div>
...
<div class="tab-pane active" id="tab_1">
    ...
    <div class="col-md-8">
        <h4><strong>5. Use Open Datasets</strong></h4>
        <p>Greater transparency means that more questions can be answered with existing data. During your next project or
           literature review, dive deeper into your colleagues' research and make use of their open datasets. Many openly
            available datasets can be found on the <a href="https://osf.io">Open Science Framework</a>; the
            <a href="https://osf.io/ezcuj/">Reproducibility Project: Psychology</a>, for example, has made its data public.</p>
...
##            then email a project coordinator if you'd like to join.</p>
    ...
    <div class="col-md-4 action-link margin-top-50">
        <a href="https://osf.io/search/?q=title:(%22data%22,%20%22results%22,%20%22syntax%22,%20%22output%22)">
            <div class="action-box">
                <i class="fa fa-bar-chart"></i>
                <p>Discover Open Data</p>
            </div>
        </a>
    </div>
</div>
