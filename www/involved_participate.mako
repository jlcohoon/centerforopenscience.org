            ...
            <div class="tab-pane active" id="tab_1">
                ...
                <div class="col-md-8">
                    ...
                    <p>Greater transparency means that more questions can be answered with existing data. Many openly
                        ...
                        You can make yours public via the OSF or other services. Some conferences enable you to share your slides
                        or poster through services like <a href="https://osf.io/meetings">OSF for Meetings</a>.</p>
                </div>

                <div class="col-md-4 action-link margin-top-50">
                    <a href="https://osf.io/search/?q=*">
                        <div class="action-box">
                            <i class="fa fa-bar-chart"></i>
                            <p>Discover Open Research</p>
                        </div>
                    </a>
                </div>
            </div>
